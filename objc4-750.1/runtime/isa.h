...
#   define ISA_BITFIELD                                                                        \
      uintptr_t nonpointer        : 1;  /*0: 32位，1: 64位*/                                    \
      uintptr_t has_assoc         : 1;  /*是否引用或被引用过*/                                    \
      uintptr_t has_cxx_dtor      : 1;  /*是否有C++或OC析构函数*/                                \
      uintptr_t shiftcls          : 44; /*isa指针地址; MACH_VM_MAX_ADDRESS 0x7fffffe00000*/    \
      uintptr_t magic             : 6;  /*是否初始化*/                                          \
      uintptr_t weakly_referenced : 1;  /*是否有弱引用*/                                         \
      uintptr_t deallocating      : 1;  /*是否正在释放中*/                                       \
      uintptr_t has_sidetable_rc  : 1;  /*是否已超最大引用数*/                                    \
