...
#ifndef __OBJC2__
#   if TARGET_OS_OSX  &&  !TARGET_OS_IOSMAC  &&  __i386__   //是i386 32位的Mac系统[TARGET_OS_IOSMAC暂时不知意义]
        // old ABI
#   else
#       define __OBJC2__ 1
#   endif
...
#else
#   define SUPPORT_TAGGED_POINTERS 1    //支持OBJC2的64位Unix系统
#endif
...
#else
#   define SUPPORT_PACKED_ISA 1 //非模拟器，非WIN32系统，且是64位的Unix系统
#endif
